...
type TagList struct {
	...
	Delimiter  string   "group:format short:d default:\n                 help:\"Print tags delimited by the given separator.\""                                                           //nolint:govet
	Delimiter0 bool     "group:format short:0 name:delimiter0            help:\"Print tags delimited by ASCII NUL characters. This is useful when used in conjunction with `xargs -0`.\"" //nolint:govet
